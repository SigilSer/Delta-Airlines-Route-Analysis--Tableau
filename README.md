...
### Custom airplane mark shapes
These custom icons were added to Tableau's Shapes repository and mapped to flight bearing so each plane visually points in its direction of travel.
